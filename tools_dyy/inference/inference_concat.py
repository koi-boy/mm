...
if __name__ == '__main__':
    ...
    pg_cfg = 'cfg/pg_libra_faster.py'
    pg_ckpt = '../a/CQ_work_dirs/pg_libra_faster_global/epoch_20.pth'
    ps_cfg = 'cfg/ps_libra_faster_r50_2.py'
    ps_ckpt = '../a/CQ_work_dirs/ps_libra_faster_r50/epoch_69.pth'
    ...
    with open('concat_testA.json', 'w') as f:
