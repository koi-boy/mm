...
if __name__ == '__main__':
    ...
    base_conf = '/home/Visionox/Visionox_code/V3_POC_code/configs/model_base_configs/config_IOFRandomCrop_101.py'
    # base_conf = '/home/Visionox/Visionox_code/V3_POC_code/configs/model_base_configs/faster_rcnn_dconv_c3-c5_r50_fpn_1x.py'
    pretrain_model = '/home/Visionox/pre_trained/resnext101_32x4d.pth'
    ...
    for i in range(1, 2):
        if i is 0:
            ...
            sample_root_ = '/home/Visionox/V3/poc_data/V3_ultimate_3/'
            process_flow = MainFlow(sample_root_, xml_img_in_same_folder)
            work_dir = '/home/Visionox/V3/work_dir/20191115_1'
        ...
        if i is 1:
            ...
            xml_img_in_same_folder = True
            process_flow = MainFlow(sample_root_, xml_img_in_same_folder)
            work_dir = '/home/Visionox/V3/work_dir/20191120_1'
        ...
        if i is 2:
            merge = True
            xml_img_in_same_folder = True
            sample_root_ = '/home/Visionox/V3/poc_data/12620V3/'
            process_flow = MainFlow(sample_root_, xml_img_in_same_folder)

            work_dir = '/home/Visionox/V3/work_dir/20191101_3'
            process_flow.start_flow(need_img=400, work_dir=work_dir,
                                    ...
                                    checkpoint_interval=4,
                                    total_epoch=64,
                                    lr_config_step=[36, 46],
                                    merge=merge,
                                    merge_dict=merge_dict,
                                    )
        if i is 3:
            sample_root_ = '/home/Visionox/V3/poc_data/V3/'
            xml_img_in_same_folder = True
            process_flow = MainFlow(sample_root_, xml_img_in_same_folder)
            work_dir = '/home/Visionox/V3/work_dir/20191028_4'
