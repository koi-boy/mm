...
train_pipeline = [
    ...
    dict(type='Resize', img_scale=[(2000, 800), (2000, 1333)], keep_ratio=True),
...
log_level = 'INFO'
work_dir = '../a/CQ_work_dirs/ga_faster_rcnn_x101_64x4d_mdconv_fpn_gn'
load_from = None
resume_from = None
workflow = [('train', 1)]
